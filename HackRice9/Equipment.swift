...
//        = [0.00869565217391304, 0.0434782608695652,
...
//        = [Array(1...12), Array(2...13), Array(3...5), Array(1...2),
//                                    Array(1...2), Array(1...5), Array(1...3), Array(3...8),
//                                    Array(4...24), Array(5...10)]
    
    var fac1: [Int]
        // = [4, 5, 1, 13, 2, 21, 11, 4, 0, 0]
    var fac2: [Int]
        // = [7, 4, 2, 21, 0, 38, 8, 5, 3, 2]
    var fac3: [Int]
        // = [4, 5, 3, 4, 1, 1, 4, 3, 6, 2]
    var fac4: [Int]
        // = [6, 5, 2, 0, 1, 7, 5, 0, 6, 1]
    var fac5: [Int]
        // = [7, 9, 3, 2, 1, 22, 8, 6, 4, 3]
    
    init(equipmentName: [String], probabilityOfFailure: [Double], hoursToFix: [Array<Int>], fac1: [Int], fac2: [Int], fac3: [Int], fac4: [Int], fac5: [Int]) {
        self.equipmentName = equipmentName
        self.probabilityOfFailure = probabilityOfFailure
        self.hoursToFix = hoursToFix
        self.fac1 = fac1
        self.fac2 = fac2
        self.fac3 = fac3
        self.fac4 = fac4
